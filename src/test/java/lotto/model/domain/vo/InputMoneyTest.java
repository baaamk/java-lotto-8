...
class InputMoneyTest {
    ...
    void _1000원_단위의_숫자가_들어올_경우_정상_반환한다() {
        InputMoney inputMoney = InputMoney.from(1_000);
    ...
    void _1000_원_미만의_숫자가_들어올_경우_예외처리() {
        assertThatThrownBy(() -> InputMoney.from(900))
    ...
    void _100_000_원_초과의_숫자가_들어올_경우_예외처리() {
        assertThatThrownBy(() -> InputMoney.from(101_300))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void _1_000_원_단위가_아닌_숫자가_들어올_경우_예외처리() {
        assertThatThrownBy(() -> InputMoney.from(9_500))
                .isInstanceOf(IllegalArgumentException.class)
